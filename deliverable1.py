...
# Deliverable1.py
# Deliverable 1 — Hybrid Credibility Scoring (Rule-Based + ML Regression)
# Notes:
#   - Rule-based score: combines domain priors, HTTPS/DOI/TLD signals, and optional citation counts
#   - ML score: linear regression on TF-IDF sentence features (prototype only)
#   - Hybrid score: weighted blend of rule-based and ML scores controlled by --alpha
...
def main():
    ...
    # 2) Rule-based scores (optionally includes citation boost)
